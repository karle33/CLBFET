...
clbf_mpc = AdaptiveClbf(use_service = False, use_mpc=True, use_trigger=False, use_IGPR=False) # bug with mpc
...
# true_dyn = DynamicsAckermannZModified(disturbance_scale_pos = .5, disturbance_scale_vel = -2.0, control_input_scale = 2.0)
...
path_to_save = '/home/wuzhixuan/Desktop/data_temp/'
...
plt.legend(['LB-FBLC-QP-MPC','FBLC-QP-MPC','LB-FBLC-MPC','LB-FBLC-QP'],bbox_to_anchor=(0,1.1,1,0.2), loc="upper center", ncol=4)
...
plt.legend(['LB-FBLC-QP-MPC','FBLC-QP-MPC','LB-FBLC-MPC','LB-FBLC-QP'], loc="upper right", ncol=2)
# plt.ylim([0,1.0])
...
plt.legend(['ref','LB-FBLC-QP-MPC','FBLC-QP-MPC','LB-FBLC-MPC','LB-FBLC-QP','barrier'],bbox_to_anchor=(0,1.2,1,0.2), loc="upper center", ncol=3)
plt.xlabel('Time (s)')
